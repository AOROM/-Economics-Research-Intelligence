...
| Evidence-linked paper summaries and email | Implemented in 0.4: offline excerpts, optional model Chinese summaries, source/number checks, cached history, UTF-8 MIME/HTML/plain-text reports, and weekly TLS SMTP delivery with conservative retry handling. Semantic entailment and causal validity still require reading the evidence. |
