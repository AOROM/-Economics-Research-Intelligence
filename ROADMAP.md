...
| Strict Chinese official-site whitelist and static-page registry | Implemented; each journal needs its real URLs/selectors and a live validation. |
...
Next priorities: validate two real Chinese official sites with saved HTML fixtures and live checks; add NBER official metadata adapter and source-specific version markers; measure coverage against hand-checked weekly snapshots; add stronger source-text extraction for treatment/control and mechanisms.
